...
// Verify that Client implements the gfscore interfaces.
var (
	_ = gfscore.ChainReader(&Client{})
	_ = gfscore.TransactionReader(&Client{})
	_ = gfscore.ChainStateReader(&Client{})
	_ = gfscore.ChainSyncReader(&Client{})
	_ = gfscore.ContractCaller(&Client{})
	_ = gfscore.GasEstimator(&Client{})
	_ = gfscore.GasPricer(&Client{})
	_ = gfscore.LogFilterer(&Client{})
	_ = gfscore.PendingStateReader(&Client{})
	// _ = gfscore.PendingStateEventer(&Client{})
	_ = gfscore.PendingContractCaller(&Client{})
)
