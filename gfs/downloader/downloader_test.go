...
type downloadTester struct {
	...
	stateDb gfsdb.Database // Database used by the tester for syncing from peers
	peerDb  gfsdb.Database // Database of the peers containing all data
...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", gfscore.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", gfscore.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", gfscore.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", gfscore.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func checkProgress(t *testing.T, d *Downloader, stage string, want gfscore.SyncProgress) {
	// Mark this method as a helper to report errors at callsite, not in here
	t.Helper()
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", gfscore.SyncProgress{
