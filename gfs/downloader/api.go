...
// Syncing provides information when this nodes starts synchronising with the Gfscore network and when it's finished.
...
type SyncingResult struct {
	...
	Status  gfscore.SyncProgress `json:"status"`
}
