...
// PeerInfo represents a short summary of the Gfscore sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Gfscore protocol version negotiated
...
//
// This method is legacy support for initial transaction exchange in gfs/64 and
// prior. For gfs/65 and higher use SendPooledTransactionHashes.
...
// Handshake executes the gfs protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("gfs/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Gfscore sub-protocol.
type peerSet struct {
