...
// DefaultConfig contains default settings for use on the Gfscore main net.
...
type Config struct {
	...
	// If nil, the Gfscore main net block is used.
	...
	// RPCGasCap is the global gas cap for gfs-call variants.
