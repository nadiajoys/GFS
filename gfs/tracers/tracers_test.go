...
import (
	...
	"github.com/gfscore/go-gfscore/tests"
)
...
var makeTest = function(tx, rewind) {
  ...
  var block   = gfs.getBlock(gfs.getTransaction(tx).blockHash);
  var genesis = gfs.getBlock(block.parentHash);
  ...
  genesis.config = admin.nodeInfo.protocols.gfs.config;
  ...
  console.log(JSON.stringify({
    ...
    input:  gfs.getRawTransaction(tx),
    result: result,
  }, null, 2));
}
*/
