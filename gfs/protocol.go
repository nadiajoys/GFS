...
const protocolName = "gfs"

// ProtocolVersions are the supported versions of the gfs protocol (first is primary).
...
// statusData63 is the network packet for the status message for gfs/63.
...
// statusData is the network packet for the status message for gfs/64 and later.
