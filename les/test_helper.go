...
import (
	...
	"github.com/gfscore/go-gfscore/accounts/abi/bind/backends"
	...
	"github.com/gfscore/go-gfscore/contracts/checkpointoracle/contract"
	...
	"github.com/gfscore/go-gfscore/eth"
	"github.com/gfscore/go-gfscore/gfsdb"
	"github.com/gfscore/go-gfscore/event"
	"github.com/gfscore/go-gfscore/les/checkpointoracle"
	"github.com/gfscore/go-gfscore/les/flowcontrol"
...
func testIndexers(db gfsdb.Database, odr light.OdrBackend, config *light.IndexerConfig) []*core.ChainIndexer {
...
func newTestClientHandler(backend *backends.SimulatedBackend, odr *LesOdr, indexers []*core.ChainIndexer, db gfsdb.Database, peers *serverPeerSet, ulcServers []string, ulcFraction int) *clientHandler {
	var (
...
func newTestServerHandler(blocks int, indexers []*core.ChainIndexer, db gfsdb.Database, peers *clientPeerSet, clock mclock.Clock) (*serverHandler, *backends.SimulatedBackend) {
	var (
		gspec = core.Genesis{
			Config:   params.AllEthashProtocolChanges,
			Alloc:    core.GenesisAlloc{bankAddr: {Balance: bankFunds}},
