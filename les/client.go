...
import (
	...
	"github.com/gfscore/go-gfscore/eth/downloader"
	"github.com/gfscore/go-gfscore/eth/filters"
	"github.com/gfscore/go-gfscore/eth/gasprice"
	...
	lpc "github.com/gfscore/go-gfscore/les/lespay/client"
...
// APIs returns the collection of RPC services the gfscore package offers.
...
// light gfscore protocol implementation.
...
func (s *LightEthereum) Stop() error {
	...
	s.chainDb.Close()
	s.wg.Wait()
	log.Info("Light gfscore stopped")
	return nil
}
