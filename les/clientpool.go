...
func newClientPool(db gfsdb.Database, freeClientCap uint64, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
...
func newNodeDB(db gfsdb.Database, clock mclock.Clock) *nodeDB {
