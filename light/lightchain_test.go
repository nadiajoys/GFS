...
func makeHeaderChain(parent *types.Header, n int, db gfsdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (gfsdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() gfsdb.Database {
	return odr.db
}
