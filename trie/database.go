...
type Database struct {
	diskdb gfsdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb gfsdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb gfsdb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() gfsdb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch gfsdb.Batch, uncacher *cleaner) error {
