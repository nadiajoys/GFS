...
import (
	...
	whisper "github.com/gfscore/go-gfscore/whisper/whisperv6"
)
...
func (sc *Client) SubscribeMessages(ctx context.Context, criteria whisper.Criteria, ch chan<- *whisper.Message) (gfscore.Subscription, error) {
