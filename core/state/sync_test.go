...
// account array.
func checkStateAccounts(t *testing.T, db gfsdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db gfsdb.Database, root common.Hash) error {
...
func checkStateConsistency(db gfsdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(gfsdb.Database), srcRoot)
