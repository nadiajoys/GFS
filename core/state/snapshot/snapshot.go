...
type Tree struct {
	diskdb gfsdb.KeyValueStore      // Persistent database to store the snapshot
...
// background thread.
func New(diskdb gfsdb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
