...
import (
	...
	"github.com/gfscore/go-gfscore/gfsdb/leveldb"
	"github.com/gfscore/go-gfscore/gfsdb/memorydb"
...
func NewDatabase(db gfsdb.KeyValueStore) gfsdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db gfsdb.KeyValueStore, freezer string, namespace string) (gfsdb.Database, error) {
...
func NewMemoryDatabase() gfsdb.Database {
...
func NewMemoryDatabaseWithCap(size int) gfsdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (gfsdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (gfsdb.Database, error) {
...
func InspectDatabase(db gfsdb.Database) error {
