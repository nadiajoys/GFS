...
func NewTable(db gfsdb.Database, prefix string) gfsdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) gfsdb.Iterator {
...
func (t *table) NewBatch() gfsdb.Batch {
...
func (b *tableBatch) Replay(w gfsdb.KeyValueWriter) error {
