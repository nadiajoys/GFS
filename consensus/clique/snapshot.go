...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db gfsdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db gfsdb.Database) error {
