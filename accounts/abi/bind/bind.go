...
//
// Detailed usage document and tutorial available on the go-gfscore Wiki page:
// https://github.com/gfscore/go-gfscore/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
