...
func (mc *mockCaller) CallContract(ctx context.Context, call gfscore.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call gfscore.CallMsg) ([]byte, error) {
