...
import (
	...
	"github.com/gfscore/go-gfscore/signer/core"
)
...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain gfscore.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to gfscore-type signature.
